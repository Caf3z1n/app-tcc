...
export function DetalhesPalestra({ palestra }: AprovarReprovarPalestraProps) {
          ...
          <ModalBody>
            <VStack fontWeight="medium" spacing="1rem" divider={<StackDivider borderColor="cores.cinzaBorda" />} mb="4" color="cores.cinzaEscuro">
              ...
              <Box w="100%" textAlign="left">
                ...
                <Text mb="0.3rem">Tipo: {palestra.tipo === 0 ? 'Presencial' : palestra.tipo === 1 ? 'Híbrida': 'Virtual'}</Text>
